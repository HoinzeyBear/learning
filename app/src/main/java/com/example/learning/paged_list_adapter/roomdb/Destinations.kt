...
data class Destinations(@PrimaryKey val id: String, val imageId: Int, val placeName: String)
...
object VacationSpots {
    ...
    var list: ArrayList<Destinations>? = null
        get() {
            ...
            for (i in images.indices) {
                ...
                val destination = Destinations(id, imageId, cityName)
